...
class AudioConvictionAnalyzer:
    ...
    def analyze_prediction_conviction(self, audio_file: str, predictions: List[Dict]) -> Dict:
        ...
        try:
            ...
            if file_size > 100:  # Skip very large files
            ...
            y, sr = librosa.load(audio_file, sr=self.sample_rate, duration=300)  # 5 minutes max
...
class TruScraperV7:
    ...
    def download_audio_for_conviction(self, video_url: str, video_id: str) -> Optional[str]:
        ...
        try:
            print("🎵 Downloading audio (first 5 minutes only)...")
            ...
            cmd = [
                ...
                '--external-downloader-args', 'ffmpeg:-ss 0 -t 300',  # First 5 minutes only
